...
class kaist_fusion(imdb):
    ...
    def gt_roidb(self):
        ...
        print('hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhw',gt_roidb)
                    ...
                    for k in range(dets.shape[0]):
                        f.write('{:s} {:.4f} {:.4f} {:.4f} {:.4f} {:.8f}\n'.
                                format(cls, dets[k, 0],
                                       dets[k, 1], dets[k, 2],
                                       dets[k, 3], dets[k, 4]))
        print('Writing kaist pedestrian detection results file done.',filepath)
